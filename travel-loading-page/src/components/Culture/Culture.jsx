          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="text-xs sm:text-sm tracking-wider">
                <p className="text-white/70">วัฒนธรรมและประเพณี</p>
                <p className="font-medium">{currentCulture.location}</p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-start justify-between gap-8 mt-8 lg:mt-0">
                  ...
                  >
                    ...
                    >
                      <motion.span
                        ...
                        animate={{
                          height: activeCategory === category.id ? 24 : 16,
                        }}
                      />
                      {category.title}
                    </button>
            ...
            >
              ...
              >
                ...
                >
                  {
                    cultureCategories.find((cat) => cat.id === activeCategory)
                      ?.title
                  }
                </motion.h2>
                <motion.p
            ...
            <div className="flex items-center space-x-6">
              <div className="text-right">
                ...
                <p className="text-xs sm:text-sm text-white/70">
                  จาก {cultureImages.length.toString().padStart(2, "0")}
                </p>
              </div>
              <motion.div
