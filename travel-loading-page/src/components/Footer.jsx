            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400 mb-6">ค้นพบประสบการณ์การท่องเที่ยวที่แตกต่าง กับเราที่พร้อมพาคุณไปในทุกที่</p>
                    ...
                    >
                        ...
                        <ul className="flex flex-wrap justify-center gap-6">
                            {menuItems.map((item) => (
                                ...
                                >
                                    <NavLink to={item.href} className="text-gray-400 hover:text-white transition-colors">
                                        {item.label}
                                    </NavLink>
                                </motion.li>
                            ))}
                    ...
                    >
                        ...
                        <p>Template Made by: <NavLink to={'https://github.com/NekoSakuraLucia/travel-landing-page'} target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 decoration-blue-400">NekoSakuraLucia</NavLink></p>
                    </motion.div>
                </div>
            </div>
        </footer>
