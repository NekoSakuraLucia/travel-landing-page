        ...
        <footer className='bg-black text-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
                ...
                <div className='flex flex-col items-center text-center'>
                    ...
                    >
                        <p>
                            © {new Date().getFullYear()} NekoSakuraLucia. All
                            rights reserved.
                        </p>
                        {/* ตัวเว็บนี้เป็นเพียง Front ธรรมดาๆ เท่านั้น เว็บจริงที่มีทั้ง front, back (ขายแล้ว)! */}
                        {/* <p className="my-2">
                            เป็นเพียงเว็บไซต์ demo เท่านั้นสนใจซื้อ source code
                            เว็บนี้ติดต่อ{' '}
                            <NavLink
